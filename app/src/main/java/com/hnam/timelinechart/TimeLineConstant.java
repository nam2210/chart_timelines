...
public class TimeLineConstant {
    ...
    public static final int DEFAULT_X = 24;

    //spacing
    public static final int DEFAULT_SPACING_16 = 16;

    //spacing
    public static final int DEFAULT_SPACING_8 = 8;

    public static final int DEFAULT_SPACING_4 = 4;
